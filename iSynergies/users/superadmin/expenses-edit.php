			...
			<div id="content">
                ...
                <?php 
					...
					if(isset($_POST['submit'])) {
						...
						$sql = mysqli_query($conn, "UPDATE expenses SET type='$type', amount='$amount', remarks='$remarks' WHERE id='$id'");
                        if($sql) {
				...
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<br /><br />
							<h2 style="margin: 0 20px;">Edit Expenses</h2>
						</div>
					</div>
						...
						<div class="row">
							<div class="col-md-6">
								...
								<select class='form-select' name='type' required>
									<option selected hidden value="<?php echo $row['type']; ?>"><?php echo $row['type']; ?></option>
                            ...
                            <div class="col-md-6">
								<label>Amount:</label>
								<input type="number" name="amount" value="<?php echo $row['amount']; ?>" class="form-control" min="1" step="1" required>
							</div>
						</div>
						<div class="row">
                            <div class="col-md-12">
                                <label>Remarks:</label>
                                <textarea class="form-control" id="remarks" name="remarks" rows="4" required><?php echo $row['remarks']; ?></textarea>
                            </div>
                        </div>
