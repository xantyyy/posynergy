                ...
                <form>
                    <div class="row g-4">
                        ...
                        <div class="col-md-5 ms-md-5" style="border: 1px solid #ddd; padding: 15px; border-radius: 5px;">
                            ...
                            <div class="mb-2 row">
                                <label for="begVoid" class="col-sm-4 col-form-label">Beg. VOID #:</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="begVoid">
                                </div>
                            </div>
                            <div class="mb-2 row">
                                <label for="endVoid" class="col-sm-4 col-form-label">End. VOID #:</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="endVoid">
                                </div>
                            </div>
                            <div class="mb-2 row">
                                <label for="begReturn" class="col-sm-4 col-form-label">Beg. RETURN #:</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="begReturn">
                                </div>
                            </div>
                            <div class="mb-2 row">
                                <label for="endReturn" class="col-sm-4 col-form-label">End. RETURN #:</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="endReturn">
                                </div>
                            </div>
                            <hr>
                            <div class="mb-2 row">
                                <label for="resetCounter" class="col-sm-4 col-form-label">Reset Counter No:</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="resetCounter">
                                </div>
                            </div>
                            <div class="mb-2 row">
                                <label for="zCounter" class="col-sm-4 col-form-label">Z Counter No:</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="zCounter">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-5 offset-md-1">
                            <div class="mb-4" style="border: 1px solid #ddd; padding: 15px; border-radius: 5px;">
                                <div class="mb-2 row">
                                    <label for="presetSale" class="col-sm-4 col-form-label">Present Accumulated Sales:</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" id="presentSale">
                                    </div>
                                </div>
                                <div class="mb-2 row">
                                    <label for="previousSale" class="col-sm-4 col-form-label">Previous Accumulated Sales:</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" id="previousSale">
                                    </div>
                                </div>
                                <div class="mb-2 row">
                                    <label for="salesDay" class="col-sm-4 col-form-label">Sales for the Day:</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" id="salesDay">
                                    </div>
                                </div>
                                <hr>
                                <h6 class="text-center" style="font-weight: bold; font-style: italic;">BREAKDOWN OF SALES</h6>
                                <div class="mb-2 row">
                                    <label for="vatSales" class="col-sm-4 col-form-label">Vatable Sales:</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" id="vatSales">
                                    </div>
                                </div>
                                <div class="mb-2 row">
                                ...
                                <div class="mb-2 row">
                                    <label for="exemptSales" class="col-sm-4 col-form-label">VAT Exempt Sales:</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" id="exemptSales">
                                    </div>
                                </div>
                                <div class="mb-2 row">
                                    <label for="zeroRated" class="col-sm-4 col-form-label">Zero Rated Sales:</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" id="zeroRated">
                                    </div>
                                </div>
                                <hr>
                                <div class="mb-2 row">
                                    <label for="grossAmount" class="col-sm-4 col-form-label">Gross Amount:</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" id="grossAmount">
                                    </div>
                                </div>
                                <div class="mb-2 row">
                                    <label for="lessDiscount" class="col-sm-4 col-form-label">Less Discount:</label>
                                    <div class="col-sm-8">
