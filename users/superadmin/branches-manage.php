                                ...
                                <table id="example" class="table display nowrap" style="width:100%">
                                    ...
                                    <tbody> 
                                        <?php 
                                            ...
                                            $sql = "SELECT * FROM (branches INNER JOIN branch_status ON branches.branch_status = branch_status.status_id) ORDER BY branch_id ASC";								
                ...
                <script>
					$(document).ready(function() {
						$('#example').DataTable( {
							...
							columnDefs: [
								{
									targets: [5], // replace 2 with the index of the column you want to exclude
									visible: true,
									className: 'no-print'
								}
							]
